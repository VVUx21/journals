...
export default function JournalsPage() {
  ...
  return (
    <>
      <Navbar />
      <div className="lg:pt-16 min-h-screen bg-[#FEFCE4] overflow-x-hidden">
                    ...
                    <div key={slideIndex} className="w-full flex-shrink-0">
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
                        {articles.slice(slideIndex * articlesPerPage, (slideIndex + 1) * articlesPerPage).map((article) => (
                          <Link key={article.id} href={`/${article.slug}`} className="space-y-4 cursor-pointer hover:opacity-80 transition-opacity">
